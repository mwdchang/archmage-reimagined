<template>
  <main>
    <h2 style="display: flex">
      <magic :magic="registerData.magic" /> &nbsp;Register
    </h2>
    <section style="display: flex; align-items: center">
      <div>
        <div class="row">
          <span style="width: 5rem">Username:</span> <input @keyup.enter="register" name="username" type="text"
            v-model="registerData.username">
        </div>
        <div class="row">
          <span style="width: 5rem">Password:</span> <input @keyup.enter="register" name="password" type="password"
